...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web_API_e_Fashion.Models.ImageSanPhamBienThe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("Id_SanPhamBienThe")
                        .IsUnique()
                        .HasFilter("[Id_SanPhamBienThe] IS NOT NULL");

                    b.ToTable("ImageSanPhamBienThes");
                });
            ...
            modelBuilder.Entity("Web_API_e_Fashion.Models.ImageSanPhamBienThe", b =>
                {
                    b.HasOne("Web_API_e_Fashion.Models.SanPhamBienThe", "SanPhamBienThe")
                        .WithOne("ImageSanPham")
                        .HasForeignKey("Web_API_e_Fashion.Models.ImageSanPhamBienThe", "Id_SanPhamBienThe");
            ...
            modelBuilder.Entity("Web_API_e_Fashion.Models.SanPham", b =>
                {
                    b.HasOne("Web_API_e_Fashion.Models.NhanHieu", "Brand")
                        .WithMany("SanPhams")
