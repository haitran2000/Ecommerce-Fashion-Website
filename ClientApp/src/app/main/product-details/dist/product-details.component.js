...
var ProductDetailsComponent = /** @class */ (function() {
    function ProductDetailsComponent(cartService, http, route, sanitized) {
        ...
        this.http.get(environment.URL_API + sanphams / chitietsanpham / " + this.id_product).subscribe(function (resp) {
            _this.product = resp; _this.list_san_pham_bien_the = _this.product.sanPhamBienThes; _this.testMarkup = _this.sanitized.bypassSecurityTrustHtml(_this.product.moTa); _this.http.post(environment.URL_API + mausacs / mau / ", {
