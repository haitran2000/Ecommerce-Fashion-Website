...
export class SanPhamThietKeService{
  ...
  public datasptk : sptk[]
   ...
   sanphamthietke:GetSPTK = new GetSPTK()
    readonly url="https://localhost:5001/api/SanPhamThietKes"
    ...
    getAllSanPhamThietKes(){
      this.http.get("https://localhost:5001/api/GetSanPhamThuongDeThietKes" ,{ headers: new HttpHeaders({"Access-Control-Allow-Origin":"*"})
    }).subscribe(
        res=>{
    ...
    getsptk(){
      this.http.get("https://localhost:5001/api/SanPhamThietKes").subscribe(
        res=>{
