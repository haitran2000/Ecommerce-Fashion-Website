...
//     this.http.get("https://localhost:5001/api/items").subscribe(res=>{
//   this.items = res as asd[]
//   console.log(this.items)
 
// })
this.http.get("https://localhost:5001/api/GetSanPhamThuongDeThietKes").subscribe(
  res=>{
  ...
  public submit(){
    ...
    const formData = new FormData();
      ...
      this.http.post('https://localhost:5001/api/GetSanPhamThuongDeThietKes', formData)
      .subscribe(res => {
