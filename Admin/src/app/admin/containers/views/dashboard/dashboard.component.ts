...
export class DashboardComponent implements OnInit {
  ...
  constructor(public http: HttpClient){
    ...
    this.dataSource = {
      ...
      data: [
        { label: 'Tháng Một', value: '290' },
        { label: 'Tháng Hai', value: '260' },
        { label: 'Tháng Ba', value: '180' },
        { label: 'Tháng Tư', value: '140' },
        { label: 'Tháng Năm', value: '115' },
        { label: 'Tháng Sáu', value: '100' },
        { label: 'Tháng Bảy', value: '30' },
        { label: 'Tháng Tám', value: '30' },
        { label: 'Tháng Chín', value: '30' },
        { label: 'Tháng Mười', value: '30' },
        { label: 'Tháng Mười Một', value: '30' },
        { label: 'Tháng Mười Hai', value: '30' },
