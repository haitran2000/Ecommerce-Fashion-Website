...
export class NavService {
	...
	MENUITEMS: Menu[] = [
		{
			title: 'Trang Chủ', active: false, path: '/home/fashion', type: 'link'
		},
		{
			title: 'Cửa hàng', active: false,path: '/shop/collection/infinitescroll', type: 'link'
		},
		{
			title: 'Tủ Đồ', type: 'sub', megaMenu: true, badge: true, badgeText: 'new', active: false, children: [
				{
		...
		{
			title: 'TRẠM IN', type: 'sub', active: false,path: '/pages/printhub'
		},
		{
			title: 'blogs', type: 'link', active: false, path: '/pages/blog/no/sidebar'
		}
	];
